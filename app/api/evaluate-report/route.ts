...
const PROMPT_VERSION = "report-v7-control-type-scope-category-fit";
...
function buildPrompt(profile: ProfileExport, pageCount: number): string {
  ...
  const activeCriteria = profile.criteria
    ...
    .map((item) => ({
      ...
      // Kontrol türü modelin 2. aşamada nasıl arama yapacağını belirler;
      // eski kayıtlarda boş olabileceği için aşamadan türetilmiş hâli gider.
