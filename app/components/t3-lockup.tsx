...
/**
 * Türkiye Teknoloji Takımı marka kilidi (yalnızca görsel bileşen).
 *
 * Üç kol 120° dönüşle yerleşir; şekil transparandır, arka planı çağıran ekran
 * belirler. Yazı rengi `currentColor` olduğu için sarmalayıcıya verilen `color`
 * hem lacivert hem açık zeminde doğru okunur.
 */
export default function T3Lockup({ className }: Props) {
  return (
    ...
    >
      ...
      <span className="t3-lockup-word" aria-hidden="true">
        Türkiye
        <br />
        Teknoloji
        <br />
