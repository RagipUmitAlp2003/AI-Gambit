...
export const ROLES: RoleDefinition[] = [
  {
    code: "00",
    title: "Moderatör",
    summary: "Rolleri atar, hesap açar ve belge akışını izler.",
    assignable: true,
  },
  {
    code: "01",
    title: "Birinci aşama yöneticisi",
    summary: "Belgeyi teslim alır, ilk düzenlemeyi yapar ve 02'ye devreder.",
    assignable: true,
  },
  {
    code: "02",
    title: "İkinci aşama yöneticisi",
    summary: "Kriter ve içerik denetimini yapar, 03'e devreder.",
    assignable: true,
  },
  {
    code: "03",
    title: "Üçüncü aşama yöneticisi",
    summary: "Değerlendirme tutarlılığını kontrol eder, 04'e devreder.",
    assignable: true,
  },
  {
    code: "04",
    title: "Nihai onay yöneticisi",
    summary: "Son düzeltmeleri işler ve belgenin güncel hâlini yayımlar.",
    assignable: true,
  },
];
