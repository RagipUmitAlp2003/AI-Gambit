-- 0015 — Katılımcı rapor sürümlerinin bütünlük alanları ve çift başvuru koruması.
--
...
-- Dosya 0015 olarak adlandırıldı: 0010 ön eki benzerlik motoru göçüyle (0010_similarity_v3)
-- çakışıyordu. schema_migrations kaydı tarihsel adıyla kalır; çalışma zamanı şeması
-- (workflow-db · addMissingColumns) aynı sütunları ad bağımsız olarak ekler.
